        ...
        # img_tensor_list = []
            for m in self.method_list:
                if m != "None":
                    ...
                    img_part = img[y0+1:y1-1,x0+1:x1-1]
                    ...
                    print(img.shape)
                    cv2.imwrite(os.path.join(save_dir, out_name), img)
                    cv2.imwrite(os.path.join(save_dir, out_part_name), img_part)
            print("Save img, Done!")
